...
namespace PDFFinder.Models.Localization
{
    public static class Ukraine
    {
        ...
        public static string PrinterName = "Ім`я Принтеру";
        public static string ProgramName = "Стандартна програма для PDF файлів";
        public static string PaperFromat = "Формат Паперу";
